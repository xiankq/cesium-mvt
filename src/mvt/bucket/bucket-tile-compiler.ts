...
export function compileBucketTile(
  ...
  const { renderTile, style, tile, tileProjection, styleIndex } = options;
...
function compileGeometryBatch(
  ...
  type BucketBuilder = Exclude<ReturnType<typeof createBucketBuilder>, undefined>;
