...
export interface MvtCircleStyleRule {
  fillColor: Color;
  outlineColor: Color;
  outlineWidth: number;
  size: number;
...
export interface MvtFillStyleRule {
  antialias: boolean;
  fillColor: Color;
  outlineColor: Color;
  outlineWidth: number;
...
export interface MvtLineStyleRule {
...
function normalizeLineCap(value: unknown): MvtLineStyleRule['cap'] {
  return value === 'butt' || value === 'square' ? value : 'round';
}

function normalizeLineJoin(value: unknown): MvtLineStyleRule['join'] {
