...
import { createFeatureMaterial } from '../src/mvt/render/style-material';
import { resolveCircleStyleRule, resolveFillStyleRule, resolveLineStyleRule } from '../src/mvt/render/style-rule';
import { StyleSet } from '../src/mvt/style/style-set';

function createRuleTestStyleSet(): StyleSet {
