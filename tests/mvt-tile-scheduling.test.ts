...
import { MvtTile } from '../src/mvt/tile/mvt-tile';
import { MvtTileCache } from '../src/mvt/tile/mvt-tile-cache';
import { MvtTileQueue } from '../src/mvt/tile/mvt-tile-queue';
import { MvtTileStore } from '../src/mvt/tile/mvt-tile-store';

describe('mvt tile scheduling', () => {
  it('pops higher priority tiles first', () => {
    const queue = new MvtTileQueue();
