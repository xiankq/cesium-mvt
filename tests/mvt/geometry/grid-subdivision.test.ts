...
describe('grid-subdivision', () => {
  describe('subdivideTriangleEdges', () => {
    it('should return empty result for empty input', async () => {
      const { subdivideTriangleEdges } = await import('@/mvt/geometry/grid-subdivision');
  ...
  describe('getGranularityForZoomLevel', () => {
    it('should return base granularity for zoom 0', async () => {
      const { getGranularityForZoomLevel } = await import('@/mvt/geometry/grid-subdivision');
  ...
  describe('getGridCellSize', () => {
    it('should calculate correct cell size', async () => {
      const { getGridCellSize } = await import('@/mvt/geometry/grid-subdivision');
